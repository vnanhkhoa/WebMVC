    ...
    <div class="container">
      <div class="col-md-8 showcase">
        <div class="flexslider">
          <ul class="slides">
            <li data-thumb="public/images/<?php echo $row['anh'] ?>">
              <div class="thumb-image"> <img src="public/images/<?php echo $row['anh'] ?>" data-imagezoom="true" class="img-responsive"> </div>
            </li>
            <li data-thumb="public/images/show1.jpg">
              <div class="thumb-image"> <img src="public/images/show1.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
            <li data-thumb="public/images/show2.jpg">
              <div class="thumb-image"> <img src="public/images/show2.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
            <li data-thumb="public/images/show3.jpg">
              <div class="thumb-image"> <img src="public/images/show3.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
          </ul>
      ...
      <div class="col-md-4 showcase">
        <div class="showcase-rt-top">
          <div class="pull-left shoe-name">
            ...
            <h4>&#36;<?php echo number_format($row['gia']*$km,3) ?></h4>
          </div>
        ...
        <div class="shocase-rt-bot">
          <div class="float-qty-chart">
            <ul>
              ...
              <li class="qty">
                <h4>QTY</h4>
                <select id="qty" class="form-control qnty-chrt">
                  <option>1</option>
                  <option>2</option>
                  <option>3</option>
                  <option>4</option>
          ...
          <ul>
            <li class="ad-2-crt simpleCart_shelfItem">
             <form action="" method="POST" accept-charset="utf-8">
               <button class="btn item_add" value="<?php echo $row['masp'] ?>" type='submit' name="cart">Add To Cart</button>
             </form>
             <button class="btn" value="<?php echo $row['masp'] ?>" type='button' name='buy'>Buy Now</button>
           </li>
         </ul>
       </div>
       <script>
         $(document).ready(function(){
          $("button[name='buy']").click(function(){
            ...
            function(data,status){
              if (status == 'success') {
                window.location.href = 'http://localhost/WebNC/Home/Checkout';
              }
            });
          });
        });
